    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (openMode == 3) {
            ...
            if (getIntent.getStringExtra("image") == "null") {
                ...
                Log.e("TAG", "img_null")
                Log.e("TAG", "null img store: " + getIntent.getStringExtra("image"))
            } else {
                img_photo!!.visibility = View.VISIBLE
                Log.e("TAG","img visible")
                Log.e("TAG", "store: " + getIntent.getStringExtra("image"))
            ...
            if (getIntent.getStringExtra("video") == "null") {
                ...
                Log.e("TAG","video visible")
                Log.e("TAG","store video path: " + getIntent.getStringExtra("video"))
        ...
        if (requestCode == 2) {
            if (resultCode == Activity.RESULT_OK && data != null) {
                data.data?.let { uri ->
                    ...
                    Log.e("TAG", insert_file.toString())
